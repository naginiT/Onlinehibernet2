...
<%Admin user=(Admin)session.getAttribute("admin"); %>
			...
			<nav class="navbar navbar-default">
				...
				<div class="collapse navbar-collapse navbar-right"
					...
					<ul class="nav navbar-nav">
						...
						<li><a href="dotentqualified.jsp"><span data-hover="Javaadmin">Dot Net</span></a></li>
						<li><a href="dotentqualified.jsp"><span data-hover="qualified">Qualified</span></a></li>
						<li><a href="dotentdisqualified.jsp"><span
						...
						<li class="active" class="dropdown"><a href="#"
							...
							<ul class="dropdown-menu agile_short_dropdown">
								<li><a href="dotentview.jsp">View</a></li>
	...
	<br>
	<br>
	<h2 style="color: red; text-align: center";>Update Selected
		Question</h2>
	<br>
	<br>
<%
...
String answer=request.getParameter("answer");
	user1.setMarks(qno);
user1.setTechnology("DotNet");
session.setAttribute("update", user1);
	%> 
	<form action="UpdateQuestion" method="post">
		...
		<h3>A:</h3>
		<textarea name="a"><%=option1 %></textarea><br>
		<h3>B:</h3>
		<textarea name="b"><%=option2 %></textarea><br>
		<h3>C:</h3>
		<textarea name="c"><%=option3 %></textarea><br>
		<h3>D:</h3>
		<textarea name="d"><%=option4 %></textarea><br>
		<h3>Correct Answer:</h3>
		<textarea name="answer"><%=answer%></textarea><br><br>
		<input type="submit"class="button" value="Update Question"></a></button>
	</form>
