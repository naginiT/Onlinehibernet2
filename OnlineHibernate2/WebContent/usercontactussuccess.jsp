			...
			<div class="w3layouts_header_left">
				<ul>
					...
					<li><a href="#" data-toggle="modal" data-target="#myModal2"><i
							class="fa fa-user" aria-hidden="true"></i> Sign Out</a></li>
		...
		<div class="agileits_w3layouts_banner_nav">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<a href="userindex.jsp"><img src="images/cubic.png" height="80"
						width="150"></a>
				...
				<div class="collapse navbar-collapse navbar-right"
					...
					<ul class="nav navbar-nav">
						...
						<li class="active"><a href="usercontactus.jsp"><span
			...
			<div class="container">
				...
				<div class="agile_team_grids_top">
					<div class="col-md-6 agileinfo_mail_grid_left">
						<form action="MailSendUser" method="post">
							<span class="input input--nariko"> <input
								...
								required="" value="<%=user.getName()%>" /> <label
								class="input__label input__label--nariko" for="input-20">
									<span class="input__label-content input__label-content--nariko"><%=user.getName()%></span>
							</label>
								...
								class="input__label input__label--nariko" for="input-21">
									<span class="input__label-content input__label-content--nariko"><%=user.getEmail()%></span>
							</label>
							</span> <span class="input input--nariko"> <input
