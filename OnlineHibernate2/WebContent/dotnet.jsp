...
<%session.invalidate(); %>
					...
					<ul class="nav navbar-nav">
						...
						<li class="active" class="dropdown"><a href="#"
							class="dropdown-toggle" data-toggle="dropdown"><span
								data-hover="Technologies">Technologies</span> <b class="caret"></b></a>
	...
	<section>
		...
		<h2 style="color: black;" align="center">.Net Development</h2>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="col-md-4">
					<img src="images/dotnet.jpeg" class="img-responsive" alt=""
						style="height: 300px; width: 100%">
				</div>
				<div class="col-md-8">
					<p class="lead" align="justify" style="color: black; font-size: 15px;">
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;One
						of the major benefits of .NET framework is its ability to allow
						rapid development of effective and robust web applications. Our
						team of experienced .NET developers and programmers are capable
						enough to utilize all the features and functional lists of Microsoft
						.NET framework to deliver scalable and powerful applications
						having ability to process a huge amount of data while ensuring
						quality and security.Our team of .NET developers helps clients in
						creating critical business applications using our proven project
						management processes and work methodologies. Beginning with
						project analyzing, defining, developing, testing, deployment and
						maintenance, we ensure all deliverables are scalable, robust and
						tailored at each and every stage of the development.</p>
					<p class="lead" style="color: black; font-size: 15px;">
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Developing
						.NET Application is a core expertise of the framework experts at
						Cubic IT Solutions who are well-aware about all the latest
						technology trends and development frameworks that empower them to
						deliver an enhanced user experience while catering all the
						business requisites.</p>
					<h3 style="color: black">.NET Application Development Services
						at Cubic IT Solutions :</h3>
					<br>
					<p class="lead" style="color: black; font-size: 15px;">* .NET
						Migration Services</p>
					<p class="lead" style="color: black; font-size: 15px;">* Custom
						.NET Application Development</p>
					<p class="lead" style="color: black; font-size: 15px;">*
						Enterprise .NET Application Development</p>
					<p class="lead" style="color: black; font-size: 15px;">*
						Application Programming Services</p>
					<p class="lead" style="color: black; font-size: 15px;">* .NET
				...
				<div class="agileits_w3layouts_footer_grids">
					...
					<div class="col-md-1 footer-agileits-w3layouts">
						...
						<ul>
							...
							<br>
							<a href="events.jsp"><p
									style="color: white; font-size: 20px;">Events</a>
							<br>
							<br>
