	...
	<section>
		<div class="container">
			<div class="center wow fadeInDown">
				<h1 style="color: black" align="center">PHP</h1>
			</div>
			<br>
			<div class="row">
				<div class="col-md-12">
					<div class="col-md-4">
						<img src="images/php.jpeg" class="img-responsive" alt="">
					</div>
					<div class="col-md-8">
						<p class="lead" align="justify" style="color: black; font-size: 15px;">
							...
							language.PHP is commonly used by people who want to build a
							simple, dynamic website quickly and effortlessly. Since its debut
							in 1995, it۪s become an extremely popular choice for web
							developers. So popular, in fact, that roughly 80% of all websites
							use it now, including many Fortune 500 companies and top
							technology startups. By the end of this track, you a۪ll have what
							it takes to begin your career in companies that use PHP, or even
							to build your own website!</p>
						<h2 style="color: black">Enterprise PHP Development Solutions
							:</h2>
						<p class="lead" style="color: black; font-size: 15px;">* HTML</p>
						<p class="lead" style="color: black; font-size: 15px;">* CSS</p>
						<p class="lead" style="color: black; font-size: 15px;">* Java
							Script</p>
						<p class="lead" style="color: black; font-size: 15px;">*
							Jquery</p>
						<p class="lead" style="color: black; font-size: 15px;">* Ajax</p>
						<p class="lead" style="color: black; font-size: 15px;">* Mysql</p>
					</div>
				</div>
			</div>
		</div>
