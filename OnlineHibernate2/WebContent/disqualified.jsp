...
%>
			...
			<nav class="navbar navbar-default">
				...
				<div class="collapse navbar-collapse navbar-right"
					...
					<ul class="nav navbar-nav">
						...
						<li class="active"><a href="disqualified.jsp"><span
						...
						<li class="dropdown"><a href="#" class="dropdown-toggle"
							...
							<li><a href="view.jsp">View</a></li>
								<li><a href="javacutofmarks.jsp">Cut of Marks</a></li>
							</ul></li>
	...
	<br><br>
	<div class="container">
  <h2>DisQualified Students from Java</h2>
<br><br>
...
List<ExamUser> java2=session2.createQuery("from ExamUser where status='DisQualified' and technology='Java'").list();
