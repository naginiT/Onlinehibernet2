...
<%Admin user=(Admin)session.getAttribute("admin"); %>
	...
	<br>
	<br>
	<h2 style="color: blue; text-align: center;">Available DotNet
		Questions from Database</h2>
	<br>
	<br>
	<a href="dotnetaddquestion.jsp?technology=DotNet" class="button">
		Add<%
		out.println("DotNet");
	%> Questions
	</a>
	...
	<%
	 ...
	 List<DotnetQuestion> java3=session2.createQuery("from DotnetQuestion").list();
	 	Iterator<DotnetQuestion> itr=java3.iterator();
	 	while(itr.hasNext()){
	 							
	 		DotnetQuestion java2=itr.next();
	...
	<br><a href="dotnetupdatequestion.jsp?questionno=<%=java2.getQno()%>&question=<%=java2.getQuestion()%>&option1=<%=java2.getOption1()%>&option2=<%=java2.getOption2()%>&option3=<%=java2.getOption3()%>&option4=<%=java2.getOption4()%>&answer=<%=java2.getAnswer() %>" 
