...
%>
				...
				<div class="collapse navbar-collapse navbar-right"
					...
					<ul class="nav navbar-nav">
						...
						<li ><a href="testingqualified.jsp"><span
								data-hover="Testing">Testing</span></a></li>
						<li class="active"><a href="testingqualified.jsp"><span data-hover="qualified">Qualified</span></a></li>
						<li><a href="testingdisqualified.jsp"><span
						...
						<li class="dropdown"><a href="#" class="dropdown-toggle"
							...
							<li><a href="testingview.jsp">View</a></li>
								<li><a href="testingcutofmarks.jsp">Cutof Marks</a></li>
							</ul></li>
	...
	<br><br><br><br><br>
	<form action="RemoveMultipleUserQ">
	<div class="container">
  <h2>Qualified Students from Testing</h2><br><br>
  <table class="table table-bordered table-hover">
	...
	int count=0;
						...
						ExamUser exam=new ExamUser();
						
						final Session session2=ConnectionData.Session();
						@SuppressWarnings("unchecked")
						List<ExamUser> java2=session2.createQuery("from ExamUser where status='Qualified' and technology='Testing'").list();
					    ...
					    <tbody>
					      ...
					      <td bgcolor="#5D7B9D"><font color="red" size="5px"><%=count %></font></td>
					        <td bgcolor="#5D7B9D"><font color="blue" size="5px"><%=qualifed.getName()%></font></td>
					        <td bgcolor="#5D7B9D"><font color="blue" size="5px"><%=qualifed.getEmail() %></font></td>
					        <td bgcolor="#5D7B9D"><font color="blue" size="5px"><%=qualifed.getMarks() %></font></td>
					...
					<% }
						exam.setTechnology("Testing");
						exam.setMarks(count);
						session.setAttribute("removeq", exam);
						 %>
					 </table>
