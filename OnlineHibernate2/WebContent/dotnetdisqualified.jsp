...
<%Admin user=(Admin)session.getAttribute("admin"); %>
			...
			<nav class="navbar navbar-default">
				...
				<div class="collapse navbar-collapse navbar-right"
					...
					<ul class="nav navbar-nav">
						...
						<li class="active"><a href="dotnetdisqualified.jsp"><span
						...
						<li class="dropdown"><a href="#" class="dropdown-toggle"
							...
							<li><a href="dotnetview.jsp">View</a></li>
								<li><a href="dotnetcutofmarks.jsp">Cut of Marks</a></li>
							</ul></li>
	...
	<div class="container">
  <h2>DisQualified Students from Dot Net</h2>
<br><br>
...
List<ExamUser> java2=session2.createQuery("from ExamUser where status='DisQualified' and technology='DotNet'").list();
