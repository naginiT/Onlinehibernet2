...
<body>
			...
			<nav class="navbar navbar-default">
				...
				<div class="collapse navbar-collapse navbar-right"
					...
					<ul class="nav navbar-nav">
						...
						<li><a href="testingqualified.jsp"><span data-hover="Javaadmin">Testing</span></a></li>
						<li><a href="testingqualified.jsp"><span data-hover="qualified">Qualified</span></a></li>
	...
	<br>
	<br>
	<h2 style="color: blue; text-align: center;">Available Testing Questions
		from Database</h2>
	<br>
	<br>
	<a href="testingaddquestion.jsp?technology=Testing" 
			class="button"> Add<%out.println("Testing"); %> Questions 
		</a><br><br>
	<br>
	...
	<table border="1" height="1" width="100%" bgcolor="#00FF00">
	 ...
	 List<TestingQuestion> java3=session2.createQuery("from TestingQuestion").list();
	 	Iterator<TestingQuestion> itr=java3.iterator();
	 	while(itr.hasNext()){
	 							
	 		TestingQuestion java2=itr.next();
	...
	<br><a href="testingupdatequestion.jsp?questionno=<%=java2.getQno()%>&question=<%=java2.getQuestion()%>&option1=<%=java2.getOption1()%>&option2=<%=java2.getOption2()%>&option3=<%=java2.getOption3()%>&option4=<%=java2.getOption4()%>&answer=<%=java2.getAnswer() %>" 
