...
{
	alert("Incorrect Email/ technology");
	}
	...
	<div class="container222">
		...
		<form action="ForgotPassword" method="post" class="form-horizontal"
			...
			Enter Email and Technology to send Password to Mail</h3>
			<fieldset>
				<!-- Text input-->
					...
					<div class="col-md-6 selectContainer">
						<div class="input-group">
							<span class="input-group-addon"><i
								class="glyphicon glyphicon-education"></i></span> <select name="technology"
