...
%>
				...
				<div class="collapse navbar-collapse navbar-right"
					...
					<ul class="nav navbar-nav">
						...
						<li ><a href="dotnetqualified.jsp"><span
								data-hover="Javaadmin">Dot Net</span></a></li>
						<li class="active"><a href="dotnetqualified.jsp"><span data-hover="qualified">Qualified</span></a></li>
	...
	<div class="container">
  <h2>Qualified Students from DotNet</h2><br><br>
  <table class="table table-bordered table-hover">
	...
	List<ExamUser> java2=session2.createQuery("from ExamUser where status='Qualified' and technology='DotNet'").list();
