	...
	<div class="container222">
		...
		<form action="UserLogin" method="post" class="form-horizontal"
			...
			<fieldset>
				...
				<div class="form-group">
					...
					<div class="col-md-6  inputGroupContainer">
						<div class="input-group">
							<span class="input-group-addon">@</span> <input type="email" name="email"
				...
				<h2 style="color:white; text-align: center">Forgot your password  .<a href="forgot.jsp">Click Here</a></h2>
			</fieldset>
		</form>
	</div>
