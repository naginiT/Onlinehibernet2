...
<body>
			...
			<nav class="navbar navbar-default">
				...
				<div class="collapse navbar-collapse navbar-right"
					...
					<ul class="nav navbar-nav">
						<li class="active"><a href="adminindex.jsp"><span
								data-hover="Home">Home</span></a></li>
						<li><a href="adminprofile.jsp"><span
								data-hover="Profile">Profile</span></a></li>
						<li><a href="qualified.jsp"><span
								data-hover="Javaadmin.jsp">Java</span></a></li>
						<li><a href="dotnetqualified.jsp"><span
								data-hover="dotnetadmin">Dot Net</span></a></li>
						<li><a href="testingqualified.jsp"><span
								data-hover="testingadmin">Testing</span></a></li>
	...
	<div class="gallery">
		...
		<p class="sub_para_agile">Ipsum dolor sit amet consectetur
			adipisicing elit</p>
