...
%> 
				...
				<div class="collapse navbar-collapse navbar-right"
					...
					<ul class="nav navbar-nav">
						...
						<li ><a href="testingqualified.jsp"><span
								data-hover="testingqualified">Testing</span></a></li>
  ...
  <table class="table table-bordered table-hover">
	...
	int count=0;
						  ...
						  Query query=session1.createQuery("select count(qno) from TestingQuestion");
						  query.uniqueResult();
						  	
						  Query query1=session1.createQuery("from TestingQuestion where qno='1'");
						  TestingQuestion java2=(TestingQuestion)query1.uniqueResult();
				    ...
				    <tbody>
				      ...
				      <tr class="success">
				      <td bgcolor="#5D7B9D"><font color="red" size="5px"><%=user1.getTechnology() %></font></td>
