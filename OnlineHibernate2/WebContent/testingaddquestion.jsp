...
<%Admin user=(Admin)session.getAttribute("admin"); %>
	...
	<br>
	<br>
	<h2 style="color: red; text-align: center";>Add  
		Testing Question</h2>
	<br>
	<br>
...
%>
	<%
	if(technology.equalsIgnoreCase("Testing")){
		JavaQuestion java=new JavaQuestion();
		
			java.setTechnology("Testing");
			session.setAttribute("add", java);
		%>
	<form action="AddQuestion" method="post">
		<h3>Add TestingQuestion :</h3>
