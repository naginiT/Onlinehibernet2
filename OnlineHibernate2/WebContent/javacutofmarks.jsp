...
%> 
	...
	<br><br><br><br><br>
	<div class="container">
  <h2>Cutof Marks for Java</h2><br><br>
  <table class="table table-bordered table-hover">
	...
	int count=0;
		  ...
		  Query query=session1.createQuery("select count(qno) from JavaQuestion");
		  query.uniqueResult();
		  	
		  Query query1=session1.createQuery("from JavaQuestion where qno='1'");
		  JavaQuestion java2=(JavaQuestion)query1.uniqueResult();
